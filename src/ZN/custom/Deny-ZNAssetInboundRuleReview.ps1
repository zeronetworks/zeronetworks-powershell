...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/Deny-ZNAssetInboundRuleReview
#>
function Deny-ZNAssetInboundRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNAssetInboundRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
