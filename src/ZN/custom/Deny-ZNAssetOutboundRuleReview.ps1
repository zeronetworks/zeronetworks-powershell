...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/Deny-ZNAssetOutboundRuleReview
#>
function Deny-ZNAssetOutboundRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNAssetOutboundRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
