...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znk8sclusterdesiredrule
#>
function Update-ZNK8SClusterDesiredRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNK8SClusterDesiredRule -RuleId $ruleId -K8SClusterId $clusterid
            ...
            ZeroNetworks.internal\Update-ZNK8SClusterDesiredRule @PSBoundParameters
        }
        catch {
            throw
        }
