...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/clear-znsettingsclusterpilotgroup
schema: 2.0.0
---

# Clear-ZNSettingsClusterPilotGroup
...
### Unset (Default)
```
Clear-ZNSettingsClusterPilotGroup -Product <String> [-AccountName <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UnsetViaIdentity
```
Clear-ZNSettingsClusterPilotGroup -InputObject <IApiIdentity> [-AccountName <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Example 1: Clear pilot group settings
```powershell
Clear-ZNSettingsClusterPilotGroup -Product segment-server
```

This cmdlet clears the pilot group settings.
