...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znassetinboundrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetInboundRulesSourceCandidate -AssetId <String> -RuleType <Int32> [-AccountName <String>]
