...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znassetsmonitored
schema: 2.0.0
---
...
```
Get-ZNAssetsMonitored [-AccountName <String>] [-Cursor <Int64>] [-Filters <String>] [-Limit <Int32>]
