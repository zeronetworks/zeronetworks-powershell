...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-zngroupsmfaidentitypolicy
schema: 2.0.0
---
...
### List (Default)
```
Get-ZNGroupsMfaIdentityPolicy -GroupId <String> -GroupType <String> [-AccountName <String>] [-AddAncestors]
...
### Get
```
Get-ZNGroupsMfaIdentityPolicy -GroupId <String> -GroupType <String> -ReactivePolicyId <String>
...
(Get-ZNGroupsMfaIdentityPolicy -Groupid $group.id -GroupType tag).Items
```
...
```powershell
$group = (Get-ZNGroup -Search "Domain controllers").Items | where {$_.Domain -eq "tag"}
Get-ZNGroupsMfaIdentityPolicy -Groupid $group.id -GroupType tag -ReactivePolicyId 5b0b1349-1714-4a38-ba07-c32a0957ed3b
```
