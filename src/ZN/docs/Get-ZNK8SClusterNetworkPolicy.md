...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znk8sclusternetworkpolicy
schema: 2.0.0
---

# Get-ZNK8SClusterNetworkPolicy
...
```
Get-ZNK8SClusterNetworkPolicy -K8SClusterId <String> [-AccountName <String>] [-Filters <String>]
...
### Example 1: List K8s cluster policies
```powershell
$k8scluster = (Get-ZNK8SCluster).Items | where {$_.Name -eq "rke"} |Select-Object -First 1
(Get-ZNK8SClusterNetworkPolicy -K8SClusterId $k8scluster.id).Items
```
...
This cmdlet lists K8s cluster network policies.
