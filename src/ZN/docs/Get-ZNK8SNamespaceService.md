...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znk8snamespaceservice
schema: 2.0.0
---

# Get-ZNK8SNamespaceService
...
### List (Default)
```
Get-ZNK8SNamespaceService -K8SNamespaceId <String> [-AccountName <String>] [-Filters <String>]
...
### Get
```
Get-ZNK8SNamespaceService -K8SNamespaceId <String> -K8SServiceId <String> [-AccountName <String>]
 [<CommonParameters>]
```
