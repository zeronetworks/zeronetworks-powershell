...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/new-znk8sclusterdesiredpolicy
schema: 2.0.0
---

# New-ZNK8SClusterDesiredPolicy
...
```
New-ZNK8SClusterDesiredPolicy -K8SClusterId <String> [-AccountName <String>] [-ChangeTicket <String>]
 [-Description <String>] [-DesiredRules <IDesiredK8SRuleBody[]>] [-IsEgressPolicy] [-IsIngressPolicy]
 [-LocalPodSelectorMatchExpressionsList <IK8SMatchExpression[]>] [-LocalPodSelectorMatchLabelsMap <List`1[]>]
 [-LocalPodSelectorYaml <String>] [-Name <String>] [-NamespaceName <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: ZeroNetworks.PowerShell.Cmdlets.Api.Models.IDesiredK8SRuleBody[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ZeroNetworks.PowerShell.Cmdlets.Api.Models.IK8SMatchExpression[]
Parameter Sets: (All)
Aliases:
...
Raw pod-selector YAML.
Parsed server-side into localPodSelector.
Mutually exclusive with localPodSelector.
...
### ZeroNetworks.PowerShell.Cmdlets.Api.Models.IK8SDesiredPolicyItemResponse
...
`DESIREDRULES <IDesiredK8SRuleBody[]>`: .
  - `Action <Int32>`: * 1 - Allow         * 2 - Block         * 3 - Force Block         
  - `ClusterId <String>`: 
  - `Direction <Int32>`: * '1' - Ingress         * '2' - Egress         
  ...
  - `[RemotePeerSelectors <List<IK8SPeerSelector>>]`: Mutually exclusive with remotePeerSelectorsYaml.
    - `[IPBlockCidr <String>]`: 
  ...
  - `[RemotePeerSelectorsYaml <String>]`: Raw NetworkPolicy-peer YAML (an array of peers, each with namespaceSelector, podSelector, and/or ipBlock). Parsed server-side into remotePeerSelectors. Mutually exclusive with remotePeerSelectors.

`LOCALPODSELECTORMATCHEXPRESSIONSLIST <IK8SMatchExpression[]>`: .
  - `Key <String>`: 
  - `Operator <Int32>`: * '1' - In         * '2' - NotIn         * '3' - Exists         * '4' - DoesNotExist         
  - `[ValuesList <List<String>>]`: 
