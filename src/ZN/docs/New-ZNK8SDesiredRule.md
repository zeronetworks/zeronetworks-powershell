...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/new-znk8sdesiredrule
schema: 2.0.0
---

# New-ZNK8SDesiredRule
...
```
New-ZNK8SDesiredRule -K8SClusterId <String> -Action <Int32> -Direction <Int32> -NetworkPolicyId <String>
 -NetworkPolicyName <String> [-AccountName <String>] [-ChangeTicket <String>] [-ClusterId <String>]
