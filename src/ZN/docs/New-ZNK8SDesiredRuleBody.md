...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/new-znk8sdesiredrulebody
schema: 2.0.0
---

# New-ZNK8SDesiredRuleBody
...
```
New-ZNK8SDesiredRuleBody -Action <String> -Direction <String> -NamespaceName <String>
 -NetworkPolicyName <String> [-ChangeTicket <String>] [-Description <String>] [-Ports <IPortsListItem[]>]
 [-RemotePeerSelectors <IK8SPeerSelector[]>] [-RemotePeerSelectorsYaml <String>] [<CommonParameters>]
```
...
### -ChangeTicket
Change Ticket associated with this rule
...
### -NamespaceName
Name of the namespace to which this rule applies
...
### -NetworkPolicyName
Name of the network policy to which this rule applies
...
### -Ports
Ports and protocols for this rule
...
### -RemotePeerSelectors
Remote peer selectors for this rule
...
Remote peer selectors for this rule in yaml format
...
`PORTS <IPortsListItem[]>`: Ports and protocols for this rule
  - `[Ports <String>]`: 
...
`REMOTEPEERSELECTORS <IK8SPeerSelector[]>`: Remote peer selectors for this rule
  - `[IPBlockCidr <String>]`: 
