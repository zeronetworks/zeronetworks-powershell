...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/remove-znassetlabel
schema: 2.0.0
---
...
```
Remove-ZNAssetLabel -AssetId <String> [-AccountName <String>] [-Labels <IKeyValuePair[]>] [-Source <Int32>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Remove
```
Remove-ZNAssetLabel -AssetId <String> -Body <IRemoveLabelsBody> [-AccountName <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-ZNAssetLabel -InputObject <IApiIdentity> -Body <IRemoveLabelsBody> [-AccountName <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentityExpanded
```
Remove-ZNAssetLabel -InputObject <IApiIdentity> [-AccountName <String>] [-Labels <IKeyValuePair[]>]
