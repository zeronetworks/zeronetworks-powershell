...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/remove-znsettingspilotgroupasset
schema: 2.0.0
---

# Remove-ZNSettingsPilotGroupAsset
...
```
Remove-ZNSettingsPilotGroupAsset -OSType <String> -Product <String> [-AccountName <String>]
 [-AssetIds <String[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Remove
```
Remove-ZNSettingsPilotGroupAsset -OSType <String> -Product <String> -Body <IPilotGroupModifyBody>
 [-AccountName <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-ZNSettingsPilotGroupAsset -InputObject <IApiIdentity> -Body <IPilotGroupModifyBody>
 [-AccountName <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentityExpanded
```
Remove-ZNSettingsPilotGroupAsset -InputObject <IApiIdentity> [-AccountName <String>] [-AssetIds <String[]>]
...
### Example 1: Remove an asset from pilot group
```powershell
Remove-ZNSettingsPilotGroupAsset -OSType windows -Product cloud-connector -AssetIds @("a:a:o8w4Bpq7")
```

This cmdlet removes assets from a pilot group.
...
```yaml
Type: ZeroNetworks.PowerShell.Cmdlets.Api.Models.IPilotGroupModifyBody
...
### ZeroNetworks.PowerShell.Cmdlets.Api.Models.IPilotGroupModifyBody
