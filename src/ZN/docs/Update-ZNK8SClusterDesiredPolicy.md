...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znk8sclusterdesiredpolicy
schema: 2.0.0
---

# Update-ZNK8SClusterDesiredPolicy
...
```
Update-ZNK8SClusterDesiredPolicy -K8SClusterId <String> -PolicyId <String> [-AccountName <String>]
 [-ChangeTicket <String>] [-Description <String>] [-DesiredRules <DesiredK8SRuleBody[]>] [-IsEgressPolicy]
 [-IsIngressPolicy] [-LocalPodSelectorMatchExpressionsList <K8SMatchExpression[]>]
 [-LocalPodSelectorMatchLabelsMap <String[]>] [-LocalPodSelectorYaml <String>] [-Name <String>] [-AsJob]
...
```yaml
Type: ZeroNetworks.PowerShell.Cmdlets.Api.Models.DesiredK8SRuleBody[]
Parameter Sets: (All)
Aliases:
...
### ZeroNetworks.PowerShell.Cmdlets.Api.Models.K8SDesiredPolicyItemResponse
...
`DESIREDRULES <DesiredK8SRuleBody[]>`: Desired rules
...
`LOCALPODSELECTORMATCHEXPRESSIONSLIST <K8SMatchExpression[]>`: Pod selector match labels
  - `Key <String>`: 
  - `Operator <Int32>`: * '1' - In         * '2' - NotIn         * '3' - Exists         * '4' - DoesNotExist         
  - `[ValuesList <List<String>>]`: 
