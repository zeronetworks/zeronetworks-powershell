...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znk8sclusterdesiredrulesmarkasdesired
schema: 2.0.0
---

# Update-ZNK8SClusterDesiredRulesMarkAsDesired
...
```
Update-ZNK8SClusterDesiredRulesMarkAsDesired -K8SClusterId <String> -RuleIds <String[]>
