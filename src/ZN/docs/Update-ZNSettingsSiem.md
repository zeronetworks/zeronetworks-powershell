...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znsettingssiem
schema: 2.0.0
---
...
```
Update-ZNSettingsSiem -ReceiverType <String> [-AccountName <String>] [-AuditsEndpoint <String>]
