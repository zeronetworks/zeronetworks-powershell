if(($null -eq $TestName) -or ($TestName -contains 'Remove-ZNSettingsPilotGroupAsset'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-ZNSettingsPilotGroupAsset.Recording.json'
