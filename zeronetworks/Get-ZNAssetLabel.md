...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znassetlabel
schema: 2.0.0
---
...
```
Get-ZNAssetLabel -AssetId <String> [-AccountName <String>] [-Filters <String>] [-Limit <Int32>]
