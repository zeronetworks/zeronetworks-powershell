...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znassetotlabel
schema: 2.0.0
---
...
```
Get-ZNAssetOtLabel -AssetId <String> [-AccountName <String>] [-Filters <String>] [-Limit <Int32>]
...
### ZeroNetworks.PowerShell.Cmdlets.Api.Models.ILabelsList
