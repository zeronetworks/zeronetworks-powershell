...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znk8sclusternamespaceservice
schema: 2.0.0
---

# Get-ZNK8SClusterNamespaceService
...
### List (Default)
```
Get-ZNK8SClusterNamespaceService -K8SClusterId <String> -K8SNamespaceId <String> [-AccountName <String>]
...
### Get
```
Get-ZNK8SClusterNamespaceService -K8SClusterId <String> -K8SNamespaceId <String> -K8SServiceId <String>
...
### Example 1: List K8s Cluster Namespace Services
```powershell
...
(Get-ZNK8SClusterNamespaceService -K8SClusterId $k8scluster.id -K8SNamespaceId $k8snamespace.Id).Items
```
...
This cmdlet lists services for a K8s Cluster Namespace.
