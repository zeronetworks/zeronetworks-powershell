...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znk8sclusterrule
schema: 2.0.0
---

# Get-ZNK8SClusterRule
...
```
Get-ZNK8SClusterRule -K8SClusterId <String> [-AccountName <String>] [-Filters <String>] [-Limit <Int32>]
