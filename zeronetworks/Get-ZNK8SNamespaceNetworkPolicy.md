...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znk8snamespacenetworkpolicy
schema: 2.0.0
---

# Get-ZNK8SNamespaceNetworkPolicy
...
```
Get-ZNK8SNamespaceNetworkPolicy -K8SNamespaceId <String> [-AccountName <String>] [-Filters <String>]
...
### Example 1: List K8s namespace policies
```powershell
...
(Get-ZNK8SNamespaceNetworkPolicy -K8SNamespaceId $k8snamespace.Id).Items
```
...
This cmdlet lists K8s namespace network policies.
