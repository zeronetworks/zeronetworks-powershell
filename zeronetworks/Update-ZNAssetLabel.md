...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znassetlabel
schema: 2.0.0
---
...
```
Update-ZNAssetLabel -AssetId <String> [-AccountName <String>] [-Labels <IKeyValuePair[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
