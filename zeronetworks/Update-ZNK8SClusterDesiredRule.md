...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znk8sclusterdesiredrule
schema: 2.0.0
---

# Update-ZNK8SClusterDesiredRule
...
```
Update-ZNK8SClusterDesiredRule -K8SClusterId <String> -RuleId <String> [-AccountName <String>]
 [-ChangeTicket <String>] [-Description <String>] [-PortsList <IPortsListItem[]>]
 [-RemotePeerSelectors <K8SPeerSelector[]>] [-RemotePeerSelectorsYaml <String>] [-AsJob] [-NoWait] [-Confirm]
...
```yaml
Type: ZeroNetworks.PowerShell.Cmdlets.Api.Models.K8SPeerSelector[]
Parameter Sets: (All)
Aliases:
...
### ZeroNetworks.PowerShell.Cmdlets.Api.Models.K8SDesiredRuleItemResponse
...
`REMOTEPEERSELECTORS <K8SPeerSelector[]>`: Remote selectors
  - `[IPBlockCidr <String>]`: 
