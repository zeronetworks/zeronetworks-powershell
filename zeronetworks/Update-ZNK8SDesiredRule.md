...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znk8sdesiredrule
schema: 2.0.0
---

# Update-ZNK8SDesiredRule
...
```powershell
Update-ZNK8SDesiredRule -K8SClusterId k:c:j3PDZgKj -RuleId R:k:EKRMycyG -Description "newdescription"
```
